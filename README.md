...
- รีเฟรช Web Tab ที่เปิดอยู่ทั้งหมดใน Instance ปัจจุบันได้ในคลิกเดียว พร้อม Progress
- Web Tab กว้างเท่ากันและปรับขนาดตามหน้าต่าง พร้อม Favicon โดยไม่มีลูกศรเลื่อน Tab
